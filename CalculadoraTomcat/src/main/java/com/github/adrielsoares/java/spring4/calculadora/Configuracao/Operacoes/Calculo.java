...
public class Calculo {
    ...
    private MapOpera opera;

    public MapOperacao getOperacaoMap() {
        return operacaoMap;
    }

    public MapOpera getOpera() {
        return opera;
    }

    public void setOpera(MapOpera opera) {
        this.opera = opera;
    }

    @Autowired
    public Calculo(MapOperacao mapOperacao, MapOpera opera) {
        this.operacaoMap = mapOperacao;
        this.opera = opera;
    }
